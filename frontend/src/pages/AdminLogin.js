      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <p className="auth-link-row">
            <Link to="/login">Patient</Link> | <Link to="/doctor-login">Doctor</Link> | <Link to="/receptionist-login">Receptionist</Link> | <Link to="/nurse-login">Nurse</Link> | <Link to="/lab-technician-login">Lab Technician</Link>
          </p>
        </div>
      </div>
    </div>
