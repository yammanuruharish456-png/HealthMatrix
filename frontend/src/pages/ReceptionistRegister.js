    ...
    <div className="auth-page">
      <div className="auth-container">
        <div className="auth-card large">
          ...
          <p className="auth-subtitle">Join Our Front Desk Team</p>
          <form onSubmit={handleSubmit}>
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <input type="text" name="employeeId" value={formData.employeeId} onChange={handleChange} placeholder="EMP-REC-001" required />
              </div>
            </div>
            <div className="form-row">
              <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="text" name="qualification" value={formData.qualification} onChange={handleChange} placeholder="Diploma, Certificate" required />
            </div>
            <div className="form-group">
          ...
          <p className="auth-footer">
            Already registered? <Link to="/receptionist-login">Login here</Link>
          </p>
        </div>
      </div>
    </div>
